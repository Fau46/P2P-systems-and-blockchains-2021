...
contract("Testing Mayor (no winner)", accounts =>{
  ...
  it("Should test constructor", async function(){
    instance = await Mayor.new(candidate_list, escrow, 7)
  })
  ...
  it("Should test compute_envelope", async function(){
    ...
    ce3 = await instance.compute_envelope(3, candidate3, 1, {from: voter3});
    ce4 = await instance.compute_envelope(4, candidate1, 1, {from: voter4});
    ce5 = await instance.compute_envelope(5, candidate3, 1, {from: voter5});
    ce6 = await instance.compute_envelope(6, candidate1, 1, {from: voter6});
    ce7 = await instance.compute_envelope(7, candidate2, 2, {from: voter7});
  ...
  it("Should test cast_envelope", async function(){
    ...
    await instance.cast_envelope(ce6, {from: voter6})
    await instance.cast_envelope(ce7, {from: voter7})
  })
  ...
  it("Should test open_envelope", async function(){
    ...
    await instance.open_envelope(3, candidate3, {from: voter3, value: 1})
    await instance.open_envelope(4, candidate1, {from: voter4, value: 1})
    await instance.open_envelope(5, candidate3, {from: voter5, value: 1})
    await instance.open_envelope(6, candidate1, {from: voter6, value: 1})
    await instance.open_envelope(7, candidate2, {from: voter7, value: 2})
  })
