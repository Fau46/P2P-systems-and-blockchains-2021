...
contract("Testing Mayor (no winner)", accounts =>{
  ...
  it("Should test compute_envelope", async function(){
    ce1 = await instance.compute_envelope(1, candidate1, 1, {from: voter1});
    ce2 = await instance.compute_envelope(2, candidate2, 1, {from: voter2});
  ...
  it("Should test open_envelope", async function(){
    await instance.open_envelope(1, candidate1, {from: voter1, value: 1})
    await instance.open_envelope(2, candidate2, {from: voter2, value: 1})
