...
contract("Testing Mayor (coalition winner)", accounts =>{
  ...
  it("Should test compute_envelope", async function(){
    ...
    ce2 = await instance.compute_envelope(2, coalition1, 1, {from: voter2});
  ...
  it("Should test open_envelope", async function(){
    ...
    await instance.open_envelope(2, coalition1, {from: voter2, value: 1})
  ...
  it("Should test mayor_or_sayonara", async function(){
    ...
    assert.equal(out.logs[0].args._candidate, coalition1);
  })
})